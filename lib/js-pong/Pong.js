...
Pong.prototype.dibujarMundo=function(){
    ...
    this.contexto.lineWidth = 2;//este es el ancho de las líneas del centro que separan los campos de los jugadores.
    ...
    this.contexto.font = "normal 110px georegular";  // Tipografia y tamaño
    this.contexto.fillText((this.puntuaciones[0]<10?" ":"")+""+this.puntuaciones[0],this.canvas.width/2-115,80);
    this.contexto.fillText((this.puntuaciones[1]<10?" ":"")+""+this.puntuaciones[1],this.canvas.width/2+20,80);
}
